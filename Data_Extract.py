...
good_dict = {key:value for key,value in good_dict.items() if value>4}
bad_dict =  {key:value for key,value in bad_dict.items() if value>4}
...
###Generate count vectors for all reviews
...
print("Good words here!!!")
for i in sorted_good_dict:
    print(i[0])

print("Bad words here!!!")
